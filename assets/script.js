...
function getDrink(drink) {
  ...
  var settings = {
	...
	$.ajax(settings).done(function (response) {
		...
		if (response.drinks[0].strIngredient7 != null && response.drinks[0].strMeasure7 != null) {
			ingredArr.push(
				" " +
		...
		if (response.drinks[0].strIngredient8 != null && response.drinks[0].strMeasure8 != null) {
			ingredArr.push(
				" " +
		...
		if (response.drinks[0].strIngredient9 != null && response.drinks[0].strMeasure9 != null) {
			ingredArr.push(
				" " +
		...
		if (response.drinks[0].strIngredient10 != null && response.drinks[0].strMeasure10 != null) {
			ingredArr.push(
				" " +
		...
		if (response.drinks[0].strIngredient11 != null && response.drinks[0].strMeasure11 != null) {
			ingredArr.push(
				" " +
		...
		if (response.drinks[0].strIngredient12 != null && response.drinks[0].strMeasure12 != null) {
			ingredArr.push(
				" " +
		...
		if (response.drinks[0].strIngredient13 != null && response.drinks[0].strMeasure13 != null) {
			ingredArr.push(
				" " +
		...
		if (response.drinks[0].strIngredient14 != null && response.drinks[0].strMeasure14 != null) {
			ingredArr.push(
				" " +
		...
		if (response.drinks[0].strIngredient15 != null && response.drinks[0].strMeasure15 != null) {
			ingredArr.push(
				" " +
